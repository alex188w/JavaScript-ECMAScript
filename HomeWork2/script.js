...
const treasureIsland = new Book("Остров сокровищ", "Стивенсон", 300);
treasureIsland.displayInfo();
...
const sergeiVlad = new Student("Сергей Владимиров", 25, "25-А");
sergeiVlad.displayInfo();
